...
<head>
    ...
    <meta name="description" content="Olusesi Ahmed Oladipupo is a fullstack web developer. I turn concepts, initiatives and user stories to functional websites.">
    <meta name="author" content="olusesi ahmed">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <title>Portfolio - Olusesi Ahmed Oladipupo</title>
...
<body class="dark">
    ...
    <div class="iknow_tm_all_wrap" data-magic-cursor="show">
        ...
        <div class="iknow_tm_modalbox">
            <div class="box_inner">
                <div class="close">
                    <a href="/"><img class="svg" src="img/svg/cancel.svg" alt="Olusesi Ahmed Oladipupo" /></a>
                </div>
        ...
        <div class="iknow_tm_fixed_background movingEffect" data-img-url="img/hero/5.jpg"></div>


        <div class="iknow_tm_fixed_content">
            <div class="container">
                <div class="fixed_content_inner">
                    ...
                    <div class="content_right">
                        ...
                        <div class="mainbar">
                            ...
                            <div id="about" class="iknow_tm_main_section active">
                                        ...
                                        <div class="left_inner">
                                            ...
                                            <div class="details">
                                                <ul>
                                                    <li>
                                                        <h3>Name</h3>
                                                        <span>Olusesi Ahmed Oladipupo</span>
                                                    </li>
                                                    <li>
                                                        <h3>Birthday</h3>
                                                ...
                                                <div class="personal">
                                                    <div class="dodo_progress">
                                                        ...
                                                        <div class="progress_inner" data-value="50">
                                                            <span><span class="label">Creativity</span><span class="number">60%</span></span>
                                                            <div class="background">
                                                                <div class="bar">
                                                                    <div class="bar_in"></div>
                                                                </div>
